...
# $${\color{yellow}a}$$ and $${\color{yellow}b}$$ Inputs (4-Bit Quantized) & Product ab (8-Bit Output)
# $${\color{yellow}c}$$ and $${\color{yellow}d}$$ Inputs (4-Bit Quantized) & Product cd (8-Bit Output)
